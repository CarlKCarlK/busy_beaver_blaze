...
export class Machine {
     ...
     * @returns {Uint8Array}
     */
    space_time_js(goal_x, goal_y, early_stop) {
        const ret = wasm.machine_space_time_js(this.__wbg_ptr, goal_x, goal_y, isLikeNone(early_stop) ? 0x100000001 : (early_stop) >>> 0);
     ...
     */
    count_js(early_stop) {
        const ret = wasm.machine_count_js(this.__wbg_ptr, isLikeNone(early_stop) ? 0x100000001 : (early_stop) >>> 0);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('busy_beaver_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
